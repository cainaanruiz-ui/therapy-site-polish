...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A romantic digital love letter to Cristina Macias — heartfelt writing, favorite memories, and photos of a love that became home." },
      { name: "author", content: "For Cristina Macias" },
    ],
    links: [
