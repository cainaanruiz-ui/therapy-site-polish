...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Accessible, personalized mental health support in Atlanta, GA. Therapy for adults, teens, children, couples and families. In-person and virtual." },
      { name: "author", content: "Happy 2 Help Counseling" },
      { property: "og:title", content: "Happy 2 Help Counseling — Atlanta Therapy, In-Person & Virtual" },
      { property: "og:description", content: "Accessible, personalized mental health support in Atlanta, GA. Therapy for adults, teens, children, couples and families. In-person and virtual." },
